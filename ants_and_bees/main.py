...
CONFIGS = {
    ...
    'alexslicerMIL':{
        ...
        'params': 'mil_scores',
        #'lr': 0.0001, # overfits 20 examples with LR 0.004
        #'lr': 0.004, # overfits 20 examples with LR 0.004
        'lr_scheduler' : util.exp_lr_decay(0.001, 0.75),
        'batch_size' : 4,
        'augment_data': False,
        'criterion' : lambda y, t: util.sparse_BCE_loss(y, t, 0.),
